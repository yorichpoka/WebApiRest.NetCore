...
namespace WebApiRest.NetCore.Api.Controllers
{
    ...
    {
        private readonly IGroupMenuBussiness _Bussiness;
        private readonly IHubContext<GroupMenuHub> _hubContext;

        public GroupMenusController(IGroupMenuBussiness bussiness, IHubContext<GroupMenuHub> hubContext)
        {
        ...
        public async Task<IActionResult> Post([FromBody] GroupMenuModel groupMenu)
        {
            try
            {
                ...
                // Emit hub
                await this._hubContext.Clients.All.SendAsync("GroupMenuCreated", value);
        ...
        public async Task<IActionResult> Put(int? id, [FromBody] GroupMenuModel groupMenu)
        {
            try
            {
                ...
                // Emit hub
                await this._hubContext.Clients.All.SendAsync("GroupMenuUpdated", groupMenu);
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            try
            {
                ...
                // Emit hub
                await this._hubContext.Clients.All.SendAsync("GroupMenuDeleted", id.Value);
        ...
        public async Task<IActionResult> Delete([FromQuery(Name = "id")]int[] id)
        {
            try
            {
                ...
                // Emit hub
                await this._hubContext.Clients.All.SendAsync("GroupMenusDeleted", id);
