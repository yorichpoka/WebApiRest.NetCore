...
namespace WebApiRest.NetCore.Controllers
{
  ...
  public class AuthorizationsController : ControllerBase
  {
    ...
    [HttpPost]
    public async Task<IActionResult> Post([FromBody] AuthorizationDto authorization)
    {
      try
      {
    ...
    [HttpPut("{idRole}/{idMenu}")]
    public async Task<IActionResult> Put(int? idRole, int? idMenu, [FromBody] AuthorizationDto authorization)
    {
      try
      {
        if (authorization == null)
