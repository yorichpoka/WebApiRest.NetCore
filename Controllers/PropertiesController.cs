...
namespace WebApiRest.NetCore.Controllers
{
  ...
  public class PropertiesController : ControllerBase
  {
    ...
    public PropertiesController(IGroupMenuDao dao)
    {
      this._Dao = dao;
    }
    ...
    // POST api/groupMenus
    [HttpPost]
    public async Task<IActionResult> Post([FromBody] GroupMenuDto groupMenu)
    {
      try
      {
        if (groupMenu == null)
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Put(int? id, [FromBody] GroupMenuDto groupMenu)
    {
      try
      {
        if (groupMenu == null)
